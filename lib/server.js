...
var SolidusServer = function( options ){
	...
	this.setupViews = function(){
		var view_files = fileset( paths.views +'/**/*.'+ DEFAULT_VIEW_EXTENSION, '' );
		view_files.on( 'match', function( file_path ){
			solidus_server.addView( file_path );
		});
	};
	...
	this.addView = function( view_path ){
